...
function initVisualPolish() {
  ...
  const motionAllowed = () => !reducedMotion.matches && !slowUpdates.matches && !connection?.saveData;
  ...
  register('.hero-editorial__cta, .btn-cv, .projects-nav__btn, .projects-archive-toggle, .contact-link', 'button');
